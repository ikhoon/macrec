...
# re-registers meeting-capture under Screen Recording + Microphone in System Settings.
...
launchctl kickstart -k "$DOMAIN/$LABEL" 2>/dev/null \
  ...
  && echo "  'meeting-capture' under both Screen & System Audio Recording and Microphone." \
