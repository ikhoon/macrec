// The Settings window: a grouped row-card form that persists to UserDefaults, its sidebar, and the
// small AppKit subclasses it leans on. Also the caption panel, which shares the same view helpers.
